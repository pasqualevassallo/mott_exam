...
class constellation_udp:
    ...
    def plot(self, x, src, dst, ep=1, lims=10000, ax=None, dark_mode=True):
        ...
        # --- QUI FORZIAMO I PARAMETRI A INTERI ---

        # Walker 1
        S1 = int(round(x[10]))     # numero di satelliti per piano
        P1 = int(round(x[11]))     # numero di piani
        N1 = S1 * P1               # numero totale satelliti Walker 1
        ...
        # Walker 2
        S2 = int(round(x[13]))     # numero di satelliti per piano
        P2 = int(round(x[14]))     # numero di piani
        N2 = S2 * P2               # numero totale satelliti Walker 2
